    ...
    <div class="content-wrapper tab-2">
        ...
        <section class="content">
          <div class="container pt-4 ">
            <p class="font-mono uppercase text-blue-800 text-center p-2">Showing content of: Theme file<span class="text-green-200" id="showFileName"></span></p>
            <textarea id="fileContent" class="p-2 w-full  font-mono tracking-wider border-none outline-none rounded-md text-white bg-gray-700" rows="20">{{ $code }}</textarea>
            <button class="rounded-md bg-gradient-to-br from-green-400 to-green-300 px-4 py-2 m-2" onclick="updatePage()">Update</button>
